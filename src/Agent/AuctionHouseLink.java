...
/**
 * Stores all the important information the agent will need to know about the Auction houses it connects to.
...
public class AuctionHouseLink {
    ...
    /**
     * Creates a new AuctionHouseLink object with the important information about the auction house.
     * @param id auction houses IDRecord
     * @param secretKey The secret Key the bank provided for interacting with the auction house
     * @param proxy the AuctionHouseProxy used to communicate/ send messages to the Auction House.
     */
